...
description: Set up your first workspace and project structure in Solarplan
---

This guide covers the first functional setup inside Solarplan so your team can begin tracking work immediately.
