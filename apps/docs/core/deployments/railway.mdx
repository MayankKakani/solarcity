---
title: Railway
description: Deploy Solarplan to Railway using the official template.
---
import { DeployButton } from "@/components/ai/page-actions";

## Railway Template

Solarplan provides an official Railway template for easy deployment with a single click.

<DeployButton href="https://railway.com/deploy/solarplan">
  Deploy on Railway
</DeployButton>
...
SOLARPLAN_API_URL=https://your-api.railway.app
SOLARPLAN_CLIENT_URL=https://your-web.railway.app
