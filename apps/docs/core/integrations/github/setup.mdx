---
title: App Setup
description: Learn how to create and configure a GitHub App for Solarplan integration. Step-by-step guide to register your Solarplan instance with GitHub.
---


This guide walks you through creating and configuring a GitHub App to enable the Solarplan integration. **Start here before deploying or configuring your Solarplan instance.**

## Overview

A GitHub App provides secure, granular access to your repositories and enables powerful bidirectional synchronization between Solarplan and GitHub:

**Task to GitHub:**
- Automatically create GitHub issues when you create tasks
- Update issue status and priority labels when you change tasks
- Add comments linking to Solarplan tasks
...
- Sync GitHub labels to Solarplan task labels
...
<Warning>
**Important**: Complete this GitHub App setup **before** deploying Solarplan. You'll need the app credentials during deployment configuration.
</Warning>
...
- **GitHub App name**: `solarplan-[your-instance-name]` (must be unique across GitHub)
- **Description**: `Solarplan project management integration`
- **Homepage URL**: Your planned Solarplan instance URL (e.g., `https://solarplan.yourdomain.com`)
- **Webhook URL**: `https://your-solarplan-instance.com/api/github-integration/webhook`
- **Webhook secret**: Generate a secure random string (save this for later)

<Warning>
Replace `your-solarplan-instance.com` with your planned Solarplan domain. The webhook URL must be publicly accessible once deployed.
</Warning>
</Step>
...
<Warning>
Keep this private key secure! It's used to authenticate your Solarplan instance with GitHub.
</Warning>
</Step>
...
The GitHub App also shows an OAuth **Client ID** and **Client Secret** under "Basic information". Solarplan’s **repository integration** does not use those environment variables; they are only relevant if you enable **Sign in with GitHub** using `GITHUB_OAUTH_CLIENT_ID` / `GITHUB_OAUTH_CLIENT_SECRET` (see [GitHub SSO](/core/social-providers/github)).
...
### App Configuration
- **Use descriptive names**: Make it clear the app is for Solarplan integration
...
- Adding your organization name: `solarplan-mycompany`
- Adding a timestamp: `solarplan-mycompany-2024`
- Using a different naming convention: `mycompany-solarplan`

### Webhook URL Not Accessible
Ensure your Solarplan instance is:
...
1. **[Deploy Solarplan](/core)** - Deploy your Solarplan instance with the GitHub App credentials
2. **[Configure GitHub Integration](/core/integrations/github/configuration)** - Complete the integration setup in your deployed Solarplan instance
