...
**Symptoms**:
- Red error message in Solarplan UI
...
<Tip>
Use the "Browse Repositories" feature in Solarplan to see which repositories your app can access.
</Tip>
...
2. **Update Installation**
   ...
   - Go to [GitHub App installations](https://github.com/settings/installations)
   - Click "Configure" on your Solarplan app
...
3. **Restart Backend Service**
   ...
   - For Kubernetes: `kubectl rollout restart deployment/solarplan-backend`
...
**Problem**: GitHub events aren't reaching Solarplan.

**Symptoms**:
- Webhook events listed in GitHub but no logs in Solarplan
...
**Problem**: Webhooks reach Solarplan but signature verification fails.
...
**Problem**: Labels aren't syncing between Solarplan and GitHub.

**Symptoms**:
- Changing priority in Solarplan doesn't update GitHub labels
- Adding labels in GitHub doesn't reflect in Solarplan
...
3. **Check Webhook Events**
   ...
   - Without these, label changes from GitHub won't sync to Solarplan
...
2. **Test Repository Access**
   - Use the "Browse Repositories" feature in Solarplan
...
4. **Check Backend Logs**
   ...
   ✅ Task created: { taskId: "...", title: "...", zoneId: "..." }
   ```
...
```
Task created: { taskId: "task_123", title: "Fix bug", zoneId: "proj_456" }
...
2. **Gather Information**
   ...
   - Check both Solarplan logs and GitHub webhook delivery logs
   - Document your environment (Docker, Kubernetes, etc.)

3. **Test Basic Functionality**
   - Try creating a task without GitHub integration
   - Verify your Solarplan instance is working normally
...
- **[GitHub Issues](https://github.com/usekaneo/solarplan/issues)** - Report bugs or request features
...
**Still stuck?** The Solarplan community is here to help! Join our [Discord](https://discord.gg/rU4tSyhXXU) for real-time support.