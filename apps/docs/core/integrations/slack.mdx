---
title: Slack
description: Send task notifications from Solarplan to a Slack channel using incoming webhooks.
---

Solarplan can post task activity to a Slack channel whenever events occur in a project. This uses Slack's incoming webhook feature — no bot token or OAuth flow required.

## Create a Slack webhook

1. Go to [api.slack.com/apps](https://api.slack.com/apps) and click **Create New App** then **From scratch**.
2. Name your app (e.g. "Solarplan") and select your workspace.
...
Solarplan sends Slack Block Kit messages with:
