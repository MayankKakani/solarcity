 ...
 * Returns null if no valid priority label found (lets Solarplan use its defaults).
 */
 ...
 * Returns null if no valid status label found (lets Solarplan use its defaults).
 */
