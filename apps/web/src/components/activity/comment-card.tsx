      ...
      <div className="group relative w-full rounded-xl border border-border/80 bg-card/60">
        ...
        <div className="pt-0.5">
          <CommentEditor
            ...
            className={
              isEditing
                ? "[&_.solarplan-comment-editor-content_.ProseMirror]:min-h-[3rem] [&_.solarplan-comment-editor-content_.ProseMirror]:max-h-none [&_.solarplan-comment-editor-content_.ProseMirror]:overflow-visible [&_.solarplan-comment-editor-content_.ProseMirror]:px-3 [&_.solarplan-comment-editor-content_.ProseMirror]:pt-2.5 [&_.solarplan-comment-editor-content_.ProseMirror]:pb-2"
                : "solarplan-comment-viewer [&_.solarplan-comment-editor-content_.ProseMirror]:px-3 [&_.solarplan-comment-editor-content_.ProseMirror]:pt-2 [&_.solarplan-comment-editor-content_.ProseMirror]:pb-3"
            }
            autoFocus={isEditing}
            readOnly={!isEditing}
