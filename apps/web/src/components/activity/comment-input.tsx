    ...
    <div className="w-full">
      <div className="rounded-xl border border-border/80 bg-card/70 transition-colors focus-within:border-ring/60 focus-within:shadow-[0_0_0_2px_color-mix(in_srgb,var(--ring)_20%,transparent)]">
        <CommentEditor
          ...
          className="[&_.solarplan-comment-editor-content_.ProseMirror]:min-h-[3rem] [&_.solarplan-comment-editor-content_.ProseMirror]:max-h-none [&_.solarplan-comment-editor-content_.ProseMirror]:overflow-visible [&_.solarplan-comment-editor-content_.ProseMirror]:px-3 [&_.solarplan-comment-editor-content_.ProseMirror]:pt-3 [&_.solarplan-comment-editor-content_.ProseMirror]:pb-2"
