    ...
    <>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          ...
          >
            <GitHubIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
          ...
          >
            <GiteaIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
          ...
          >
            <DiscordIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
          ...
          >
            <GenericWebhookIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
          ...
          >
            <SlackIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
          ...
          >
            <TelegramIntegrationSettings zoneId={zoneId} />
          </IntegrationSection>
        </div>
      </div>
    </>
