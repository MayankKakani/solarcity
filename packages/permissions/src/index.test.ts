...
describe("@solarplan/permissions statement surface", () => {
  it("exposes Solarplan's resource statements alongside better-auth defaults", () => {
...
describe("built-in role privileges", () => {
  ...
  it("owner has every Solarplan resource action including workspace:delete", () => {
